        ...
        try {
	        ...
	        if (query.length() > 6 && 
		        ...
		        while(queryResult.next()) {
		        	...
		        	if(Integer.parseInt(queryResult.getString(1))!=0) {
		        	out.println("<td>");
		        	out.println("<form action='OrdersServlet' method='post'>");
		        	out.println("<button name ='query'  value='INSERT INTO Invoices(ID_Invoices,ID_Orders) VALUES ("+queryResult.getObject(1)+","+queryResult.getObject(1)+")' >CREATE INVOICE</button>");
